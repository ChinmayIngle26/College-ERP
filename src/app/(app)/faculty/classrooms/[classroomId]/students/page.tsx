    ...
    <>
      ...
      <div className="p-6 space-y-6">
        ...
        <h2 className="text-2xl font-bold tracking-tight md:text-3xl">
          Manage Students for: {loadingStudents ? <Skeleton className="inline-block h-8 w-48" /> : classroomName || 'Classroom'}
        </h2>

        <Card>
          <CardHeader>
            <CardTitle>Current Students ({currentStudents.length})</CardTitle>
            <CardDescription>Students currently enrolled in this classroom. Batches are auto-assigned (e.g., 'A-001' to Batch 'A') if ID format matches, otherwise assign manually.</CardDescription>
          </CardHeader>
          <CardContent>
            {loadingStudents ? (
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Search for students by name, email, or student ID to add them to this classroom. Batch will be auto-assigned if student ID format is like 'A-123'.</CardDescription>
          </CardHeader>
          <CardContent>
